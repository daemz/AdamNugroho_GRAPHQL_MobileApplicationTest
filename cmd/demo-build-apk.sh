...
apk_with_version=app-demo-release-$app_version.apk

./gradlew assembleRelease --no-daemon
cd app/build/outputs/apk/release
mv app-release.apk $apk_with_version
open .
cd ../../../../../../

adb install -r android/app/build/outputs/apk/release/$apk_with_version

say "yo, build demo APK done"
